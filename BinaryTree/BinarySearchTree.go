...
func heightMax(node *BinarySearchTreeNode, h int) int {
	var hL = h
	var hR = h
...
func LDR(tree Tree) {
	...
	i := 0
	var currentNode *BinarySearchTreeNode
...
func insertNode(tree Tree, insertValue int) Tree {
	var currentNode *BinarySearchTreeNode
	var tmp *BinarySearchTreeNode
	i := 0
	if tree.length == 0 {
		currentNode = new(BinarySearchTreeNode)
